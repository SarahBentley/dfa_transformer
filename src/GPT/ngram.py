...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None, use_flash=True):
        ...
        padding_mask = padding_mask & torch.tril(torch.ones(t, t, device=device)).bool()  # causal mask combined with padding mask
        ...
        for block in self.transformer.h:
            x = block(x, attn_mask=padding_mask, use_flash=use_flash)
